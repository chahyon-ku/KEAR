...
def get_args():
    ...
    parser.add_argument('--deepspeed', action='store_true', help='store every time the model is evaluated.')
    ...
    if args.preset_model_type=='albert':
        ...
        args.model_type = 'debertav2'
    # ----- Smaller models for local training
        ...
        args.model_type = 'debertav2'
    elif args.preset_model_type == 'debertav3-small':
        args.bert_model_dir = 'microsoft/deberta-v3-small'
        args.bert_vocab_dir = 'microsoft/deberta-v3-small'
        args.model_type = 'debertav2'
    elif args.preset_model_type == 'debertav3-xsmall':
        args.bert_model_dir = 'microsoft/deberta-v3-xsmall'
        args.bert_vocab_dir = 'microsoft/deberta-v3-xsmall'
        args.model_type = 'debertav2'
